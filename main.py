        ...
        for uid in uids:
            ...
            try:
                ...
                for part in alle_parts:
                    ...
                    # Normaliseer Content-Disposition: verwijder newlines/tabs
                    ...
                    if ct == "text/plain" and "attachment" not in cd:
                        try:
                            ...
                            pass
                    elif ct in ("application/pdf", "image/jpeg", "image/png", "image/jpg", "image/gif", "application/octet-stream") or                          ("attachment" in cd and ct not in ("text/plain", "text/html")):
                        # PDF altijd opslaan, ongeacht Content-ID of disposition
