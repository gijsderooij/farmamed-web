...
async def verstuur_smarthub(request: Request):
    ...
    uit de ruwe WooCommerce-order — dat kon de bevestigde correcties uit de
    tabel eerder stilzwijgend negeren.
    """
    ...
    # Order altijd ophalen — nodig voor billing-fallback en onze eigen
    # DB-boekhouding hieronder, ook als het te versturen bericht al klaarstaat.
