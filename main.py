...
async def startup_event():
    if _DATABASE_URL:
        try:
            ...
            print(f"[startup] Schema-migratie voorschrijvers.telefoon fout: {e}")
    ...
    try:
        ...
        def _voeg_wc_orders_toe(ruwe_orders, verwacht_email):
            ...
            for o in ruwe_orders:
                ...
                # Hoeveelheid is niet apart opgeslagen als meta, maar zit verwerkt in het
                # aantal tubes van het medicijn-line-item (1 tube = 30 gram) — reconstrueren:
